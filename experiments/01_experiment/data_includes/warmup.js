...
Template("warmup1.csv",
    row => newTrial("warmup1",
        newText("next", "<br>Press SPACE BAR to continue").center(),
...
newTrial("mid warmup",
    newText("We will now remove the instructions.").center().print(),
...
Template("warmup2.csv",
    row => newTrial("warmup2",
        getVar("score").test.is(3).success(end()),
        newImage("cross", "cross.png").print(),
        newTimer("wait", 700).start().wait(),
        getImage("cross").remove(),
...
newTrial("end of warmup",
    newText("You have successfully completed the practice round!").print(),
    newText("You will now see and evaluate real player-robot interactions. Our robot counts on your feedback to improve its guesses !").print(),
