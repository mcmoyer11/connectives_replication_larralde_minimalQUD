newTrial( "debrief" ,
    newImage("thankyou.png")
    .center()
      .print(),
    newText("Your participation helped us tremendously in our research.").print(),
    ...
    newTextInput().center().settings.size(400,200).print().log(),
    newText("<p><br>Click on continue to obtain your prolific completion code.").print(),
    newText("<br>").print(),
    newButton("Continue").center().print().wait()
    )
    newTrial("prolific",
    newText("<br>Please click <a href='https://app.prolific.co/submissions/complete?cc=7B46E2F5'> here</a> to obtain your prolific completion code.").center().print(),
