...
Template(GetTable("EXP2_test_items_set_1_2.csv").setGroupColumn("Group"),
    ...
    row => newTrial("test",
        ...
        ,
        // First conjunct
        newText("one", row.Screen2).settings.css("font-size", "70")
            .print()
        ,
        newVar("RT1")
            .global()
        ...
        ,
        getVar("RT2")
            .set(v => Date.now() - v)//.log( "ReactionTime2" , getVar("RT2")
        ,
        getText("two")
            .remove()
        ,
        // Presentation of the three letters
        newText("three", row.Screen11)
            .settings.css("font-size", "70")
        ,
        newText("four", row.Screen12)
            .settings.css("font-size", "70")
        ,
        newText("five", row.Screen13)
            .settings.css("font-size", "70")
        ,
